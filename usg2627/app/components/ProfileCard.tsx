  ...
  return (
    <>
      <motion.div
        ...
        whileTap={{ scale: 0.99 }}
        className="group overflow-hidden rounded-2xl border border-slate-200 bg-white/90 p-6 shadow-sm transition-colors duration-300 hover:border-[#173490]/40 flex flex-col justify-between backdrop-blur-xs"
      >
        <div>
