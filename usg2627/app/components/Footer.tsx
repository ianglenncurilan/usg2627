        ...
        <div className="grid grid-cols-1 gap-12 md:grid-cols-2 lg:grid-cols-4">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-slate-300">
              <li>
                <Link href="/documents?category=Resolutions" className="transition hover:text-white">
                  Resolutions
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-slate-300">
              <li>
                <Link href="/about#executive" className="transition hover:text-white">
                  Executive Branch
                </Link>
              </li>
              <li>
                <Link href="/senate" className="transition hover:text-white">
                  Student Senate
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link href="/committees" className="transition hover:text-white">
                  Committees
                </Link>
              </li>
            </ul>
